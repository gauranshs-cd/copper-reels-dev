-- Step-by-Step Schema Creation for Copper Reels
-- Run each section one at a time to avoid dependency issues
...
-- ============================================
-- STEP 3: Tables that depend on profiles
-- ============================================
...
-- ============================================
-- STEP 4: Tables that depend on channels
-- ============================================
...
-- ============================================
-- STEP 5: Creative Briefs (depends on sessions and channels)
-- ============================================
...
-- ============================================
-- STEP 6: Tables that depend on creative_briefs
-- ============================================
...
-- ============================================
-- STEP 7: Tables that depend on ideas
-- ============================================
...
-- ============================================
-- STEP 8: Tables that depend on video_plans
-- ============================================
...
-- ============================================
-- STEP 9: Generation Logs (depends on sessions)
-- ============================================
...
-- Creative briefs policies
CREATE POLICY "Users can view own creative briefs" ON public.creative_briefs
  FOR SELECT USING (
    session_id IN (
...
CREATE POLICY "Users can insert own creative briefs" ON public.creative_briefs
...
CREATE POLICY "Users can update own creative briefs" ON public.creative_briefs
  FOR UPDATE USING (
    session_id IN (
      SELECT id FROM public.sessions WHERE user_id = auth.uid()
    )
...
-- Generation logs policy (anyone can insert, no one can read)
CREATE POLICY "Anyone can insert generation logs" ON public.generation_logs
